...
public class AgeGroupBL {
    ...
    public AgeGroupBL(String _Evt, int _ClassCode, String _ClassName, int _AgeGroup, String _Note) {
        Evt = _Evt;
    ...
    public AgeGroupBL(String _Evt, int _ClassCode) {
        Evt = _Evt;
        ClassCode = _ClassCode;
        connec = new MyConnection();
    }
